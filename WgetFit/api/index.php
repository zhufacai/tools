...
<div class="container">
    ...
    <div class="row mb-5">
        <div class="col-12 col-lg-7 mb-4 mb-lg-0">
            <h1 class="h4">API文档</h1>
             <label>请求参数：<code>url</code>(必填),<code>email</code>(非必填)</label>
           
         <div class="card bg-gray-50 border-0">
                <div class="card-body">
            if (isset($_POST['url'])) {</br>
	$result = json_decode(get_curl('https://wget.fit/api.php','url='.$_POST['url'],'email='.$_POST['email'),true);</br>
	if ($result['code'] < 0) {</br>
		exit (json_encode(array('code' => '-1', 'msg' => $result['msg'])));</br>
	} else {</br>
        exit(json_encode(array('code' => '1', 'msg' => '爬取成功，请下载！', 'down' =></br> $result['down'])));
    }</div>
        </div>
        ...
        <div class="col-12 col-lg-4 offset-lg-1">
            ...
            <div class="form-group">
                <label for="base_url">基于URL</label>
                <input type="text" id="base_url" value="https://wget.fit/api.php" class="form-control" readonly="readonly">
            </div>
            <div class="form-group">
                <label for="base_url">返回格式</label>
                <input type="text" id="base_url" value="json/text" class="form-control" readonly="readonly">
            </div>
              <div class="form-group">
                <label for="base_url">请求方式</label>
                <input type="text" id="base_url" value="post/get" class="form-control" readonly="readonly">
            </div>
            <div class="mb-3">
                <a href="https://wget.fit/WgetFitCode.zip" target="_self" class="btn btn-block btn-outline-primary">实例代码下载</a>
            </div>
